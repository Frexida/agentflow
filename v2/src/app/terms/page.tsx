    ...
    <main className="min-h-screen bg-[var(--surface)]">
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6 text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">8. Ownership of Generated Content</h2>
            <p>
              All content you create using AgentFlow — including organization designs, exported configurations,
              and any outputs generated by AI agents running on your Gateway — belongs to you.
              We claim no ownership or intellectual property rights over your generated content.
            </p>
            <p className="mt-2">
              By using the Service, you grant us only the limited, technical permissions necessary to
              store and deliver your content back to you (e.g., saving designs to the cloud).
              We will not use your content for training, marketing, or any other purpose without your explicit consent.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">9. Account Termination</h2>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              ...
              <li>Abuse the Service infrastructure (e.g., excessive resource consumption, denial-of-service behavior)</li>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">10. Cancellation &amp; Refund Policy</h2>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              ...
              <li>No partial refunds are provided for the remaining days in the billing period.</li>
              <li>After the billing period ends, your account reverts to the Free plan.</li>
            </ul>
            <p className="mt-2">
              <strong>Refund exceptions:</strong> If you experience a significant service outage or
              billing error caused by us, contact us within 14 days for a full or prorated refund
              at our discretion.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">11. Open Source</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">12. Disclaimers</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">14. Changes</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">16. Contact</h2>
            <p>
