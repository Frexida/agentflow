      ...
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6 text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              <strong>Upon termination:</strong> Your cloud-stored data will be deleted after a 30-day grace period.
              You may export your data before termination takes effect. Local data in your browser remains unaffected.
            </p>
            <p className="mt-2">
              You may delete your own account at any time from Settings. We may retain anonymized, aggregated data
